...
TBlockIter* BlockBasedTable::NewDataBlockIterator(
  ...
  //***** fd 하드코딩 *****//
  //"/usr/local/rocksdb/000116.sst" = 4
  //"/usr/local/rocksdb/000051.sst" = 4
  // const int fd = 4;

  // s = RetrieveBlockByOffset(fd,prefetch_buffer, ro, handle, dict, &block, block_type,
  //                   get_context, lookup_context, for_compaction,
  //                   /* use_cache */ true, /* wait_for_cache */ true);이거수정
...
TBlockIter* BlockBasedTable::NewDataBlockIterator(const ReadOptions& ro,
                                                  ...
                                                  Status s) const {
  std::cout << "BlockBasedTable::NewDataBlockIterator2" << std::endl;
...
TBlockIter* BlockBasedTable::KetiNewDataBlockIterator(
    ...
    FilePrefetchBuffer* prefetch_buffer, bool for_compaction) const {
  //이거로 들어옴 확인
  //std::cout << "[func call] block_based_table_reader.cc > BlockBasedTable::KetiNewDataBlockIterator"<< std::endl;
  ...
  s = RetrieveBlockByPBA(prefetch_buffer, ro, &block, get_context, 
                      ...
                      /*prefetch_buffer, ro, handle, dict, &block, block_type,
                    usecache-false,  waitforcache-false*/);
