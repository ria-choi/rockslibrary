...
//추가
Status KetiReadTablePropertiesHelper(
    const int fd,
    const ReadOptions& ro, const BlockHandle& handle,
    RandomAccessFileReader* file, FilePrefetchBuffer* prefetch_buffer,
    const Footer& footer, const ImmutableOptions& ioptions,
  ...
  // std::cout << "[func call] meta_blocks.cc > KetiReadTablePropertiesHelper" << std::endl;
  ...
  BlockFetcher block_fetcher(file, prefetch_buffer, footer, modified_ro, handle,
                             ...
                             UncompressionDict::GetEmptyDict(),
                             PersistentCacheOptions::kEmpty, memory_allocator,
                             nullptr /* memory_allocator_compressed */, false /* for_compaction */,
                             fd /*block_fetcher에 fd 추가*/);//수정
  
  Status s = block_fetcher.ReadBlockContentsByOffset();//수정
...
Status ReadTableProperties(RandomAccessFileReader* file, uint64_t file_size,
  ...
  std::cout << "meta_blocks.cc > ReadTableProperties" << std::endl;
...
Status FindOptionalMetaBlock(InternalIterator* meta_index_iter,
                             ...
                             BlockHandle* block_handle) {
  // std::cout << "[func call] meta_blocks.cc > FindOptionalMetaBlock" << std::endl;
...
Status FindMetaBlock(InternalIterator* meta_index_iter,
                     const std::string& meta_block_name,
                     BlockHandle* block_handle) {
  std::cout << "meta_blocks.cc > FindMetaBlock" << std::endl;
...
Status FindMetaBlockInFile(RandomAccessFileReader* file, uint64_t file_size,
                           ...
                           FilePrefetchBuffer* prefetch_buffer,
                           Footer* footer_out) {
  std::cout << "meta_blocks.cc > FindMetaBlockInFile" << std::endl;
...
Status ReadMetaBlock(RandomAccessFileReader* file,
                     ...
                     MemoryAllocator* memory_allocator) {
  std::cout << "meta_blocks.cc > ReadMetaBlock" << std::endl;
